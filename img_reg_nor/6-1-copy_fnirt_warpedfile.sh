...
RSYNC_DIR="${BASE_DIR}/3_nonlinear_18001-28002"

# Create rsync directory if it doesn't exist
mkdir -p "${RSYNC_DIR}"

# Third process: 6001-12000 (First and second ones are below)
echo "Starting copy process for 18001-28002..."
INPUT_BASE="${BASE_DIR}/normalized2mni152_1mm_18001-28002wo18"
...
done < "/ibic/scratch/royseo_workingdir/scripts/subj_list_ADNI1234_28002_18001-28002_1_20_2025.log"

echo "Copy process for 18001-28002 complete"
