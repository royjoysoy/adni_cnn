...
ln -sf $JOB_NAME.$TASK_ID.stdout fnirt_stdout_12001-18000/$JOB_NAME.task${TASK_ID}_${subject}.stdout
ln -sf $JOB_NAME.$TASK_ID.stderr fnirt_stderr_12001-18000/$JOB_NAME.task${TASK_ID}_${subject}.stderr
