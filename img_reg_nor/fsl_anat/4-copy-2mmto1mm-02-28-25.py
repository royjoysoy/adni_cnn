#02-28-2025 South Korea Roy Seo
#!/usr/bin/env python3
"""
...
def main():
    ...
    target_dir = "/ibic/scratch/royseo_workingdir/fsl_anat/processed/2mmto1mm"
    ...
    with open(log_file, 'w') as log:
        ...
        for i, anat_dir in enumerate(anat_dirs, 1):
            ...
            source_file = os.path.join(anat_dir, "T1_to_MNI_nonlin_1mm.nii.gz")
            
            # Create new filename by removing .anat and adding underscore
            new_name = base_name.replace(".anat", "") + "_T1_to_MNI_nonlin_1mm.nii.gz"
            ...
            try:
                ...
                log.write(f"SUCCESS: Copied {base_name}/T1_to_MNI_nonlin_1mm.nii.gz to {new_name}\n")
                processed += 1
            except Exception as e:
