...
echo "Reading subject from: ${SCRIPT_DIR}/subj_list_ADNI1234_28002_18001-28002.log"

# Get subject identifier from the list file
subject=$(sed -n -e "${SGE_TASK_ID}p" "${SCRIPT_DIR}/subj_list_ADNI1234_28002_18001-28002.log")
