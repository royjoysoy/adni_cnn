...
#$ -N adnijob
#$ -V
#$ -t 1-10001          # 10001 subjects 가 돌 수 있도록 바꿈 
#$ -cwd
...
myprog="/ibic/scratch/royseo_workingdir/scripts/3-3-run_fs_modified_plus_normalized2mni152_1mm_fsl_flirt_linear_transform.sh"
...
#log file 바꿔줌
subject=$(sed -n -e "${SGE_TASK_ID}p" "$DIR/subj_list_ADNI1234_28001_18001-28001.log") 
