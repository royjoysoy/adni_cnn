...
# CSV 파일들을 읽어옵니다
ida_search = pd.read_csv('/Users/test_terminal/Desktop/adni_cnn/behavioral/idaSearch_11_18_24.csv')
ida_search_unmatched = pd.read_csv('/Users/test_terminal/Desktop/adni_cnn/behavioral/idaSearch_11_18_24_unmatched.csv')
...
# 결과를 CSV 파일로 저장
output_path = os.path.join(save_dir, 'merged_df_modified_idaSearch_11_18_24.csv')
