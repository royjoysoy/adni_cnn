...
from torch.optim.lr_scheduler import _LRScheduler, CosineAnnealingLR # model 2 update 1
# model 2 update 2
...
class TrainingConfig:
    ...
    # Default paths
        ...
        parser.add_argument('--simclr_batch_size', default=128, type=int,
                        help='Batch size for SimCLR training')
        parser.add_argument('--simclr_epochs', default=32, type=int,
                        help='Number of epochs to train for SimCLR')
        parser.add_argument('--warmup_epochs', default=10, type=int,
                        help='Number of epochs for learning rate warm-up')
        
        # Linear evaluation parameters
        parser.add_argument('--linear_eval_batch_size', default=16, type=int,
                        help='Batch size for linear evaluation')
        parser.add_argument('--linear_eval_epochs', default=32, type=int,
