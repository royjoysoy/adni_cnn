...
from model_model_2 import SimCLR3DCNN # model 2 update 2
from data_loading_model_2 import get_data_loaders, get_mr_transforms
from training_model_2 import run_ablation_study, linear_eval, final_evaluation
from utils_model_2 import TrainingConfig, save_model, plot_learning_curves, get_hardware_info
...
def main():
    ...
    best_linear_eval_acc, best_epoch, linear_eval_time = linear_eval(net, train_loaders['base'], val_loader, # Using only base transformation for linear evaluation
