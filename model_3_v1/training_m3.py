...
def linear_eval_all_augs(net: torch.nn.Module, 
    ...
    Args:
        ...
        train_loaders: Dictionary of train loaders for different augmentation types
        val_loader: Validation data loader
        optimizer: Optimizer for training
        linear_eval_epochs: Number of epochs for linear evaluation
        linear_eval_batch_size: Batch size for linear evaluation
        writer: TensorBoard writer
        warmup_epochs: Number of warmup epochs for the scheduler (default: 5)
    
    Returns:
        dict: Results for each augmentation type containing best accuracy and timing information
    """
    results = {}
    device = next(net.parameters()).device
    ...
    for aug_type, train_loader in train_loaders.items():
        ...
        # Reset the optimizer for the new classifier
